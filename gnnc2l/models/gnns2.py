...
# PyroMLP
class PyroMLP_2Layer(PyroModule):
    """PyroMLP_2Layer with sampled weights and biases"""
    def __init__(self, input_dim=11, output_dim=1, emb_dim=64, adj=None, activation_fn=None, bias=True):
        super(PyroMLP_2Layer, self).__init__()
...
# PyroGCN
class PyroGCNModel_2Layer(PyroModule):
    """PyroModule with sampled weights and biases"""
    def __init__(self, input_dim=11, output_dim=1, emb_dim=64, adj=None, activation_fn=None, bias=True):
        super(PyroGCNModel_2Layer, self).__init__()
        self.input_dim = input_dim
        self.output_dim = output_dim
        self.emb_dim = emb_dim
        self.adj = adj
...
class GATAModel_2Layer(PyroModule):
    ...
    def __init__(self, input_dim, output_dim, emb_dim=64, adj=None, edge_dim=None, activation_fn=None, bias=True):
        super(GATAModel_2Layer, self).__init__()
        self.input_dim = input_dim
        self.output_dim = output_dim
        self.emb_dim = emb_dim
        self.adj = adj
...
class InvariantASFModel_2Layer(PyroModule):
    ...
    def __init__(self, input_dim, output_dim, edge_dim, emb_dim=64, activation_fn=None, bias=True, **kwargs):
        super(InvariantASFModel_2Layer, self).__init__()
        self.input_dim = input_dim
        self.output_dim = output_dim
        self.edge_dim = edge_dim
        self.emb_dim = emb_dim
...
class EquivariantASFModel_2Layer(PyroModule):
    """PyroModule for Equivariant MPNN designed for modelling A_SF (or rather modulating it)

    """
    def __init__(self, input_dim, output_dim, edge_dim, emb_dim=64, activation_fn=None, bias=True, **kwargs):
        super(EquivariantASFModel_2Layer, self).__init__()
        self.input_dim = input_dim
        self.output_dim = output_dim
        self.edge_dim = edge_dim
        self.emb_dim = emb_dim
