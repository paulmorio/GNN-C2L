...
import gnnc2l.plt as c2lpl
from gnnc2l.utils._spatial_knn import spatial_neighbours, sum_neighbours
...
def run_colocation(
    ...
    Parameters
        ----------
        sp_data:
             Anndata object with gnnc2l model output in .uns['mod']
    ...
    if type(model_name) is str:
        import gnnc2l.models.downstream as models
    ...
    for n_fact in train_args["n_fact"]:
        ...
        try:
            ...
            print("Some error in plotting with scanpy or `gnnc2l.plt.plot_factor_spatial()`\n " + str(e))
